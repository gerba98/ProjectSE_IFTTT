...
public class CreateRuleController {
    ...
    @FXML
    final ObservableList<String> triggersList = FXCollections.observableArrayList("Time of the Day","File dimension","File existence"); //"Day of the week","Day of the month","Date","Status program");
    @FXML
