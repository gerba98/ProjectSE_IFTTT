 ...
 * istanze di ExecuteProgramAction. Questa classe estende ActionCreator
...
public class ExecuteProgramActionCreator extends ActionCreator {
    ...
    /**
     * Crea un'istanza di ExecuteProgramAction basata sul valore dell'azione fornito.
     *
     * @param actionValue una stringa contenente il percorso del programma e i comandi
     *                    separati da un punto e virgola, nel formato
     *                    "programPath;command".
     ...
     *
     * @return una string che rappresenta il tipo di azione, in questo caso "Execute Program".
     */
    @Override
